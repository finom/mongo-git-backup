...
async function daemonizeExport(options) {
    ...
    const instancesPath = `${homedir}/.pm2/.mongo-git-backup-instances.json`;
    ...
    console.log(await run(`pm2 start ${__dirname}/daemon.js --force --name="mongo-git-backup" --error="${homedir}/.pm2/.mongo-git-backup-error.log" --log="${homedir}/.pm2/.mongo-git-backup-out.log"`));
