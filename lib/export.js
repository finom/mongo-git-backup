...
async function daemonizeExport(options) {
    ...
    console.log(await run(`pm2 start ${__dirname}/daemon.js --name="mongo-git-backup" --error="${homedir}/.pm2/.mongo-git-backup-error.log" --log="${homedir}/.pm2/.mongo-git-backup-out.log"`));
